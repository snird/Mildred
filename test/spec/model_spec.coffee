describe 'Model', ->
  ...
  it 'should serialize the attributes', ->
    ...
    model2 = new Mildred.Model id: 2, number: 'two'
    model3 = new Mildred.Model id: 3, number: 'three'
    model4 = new Mildred.Model id: 4, number: 'four'
    model5 = new Mildred.Model id: 5, number: 'five'
  ...
  it 'should serialize nested Backbone models and collections', ->
    ...
    collection = new Backbone.Collection [
      new Mildred.Model id: 4, number: 'four'
