describe 'CollectionView', ->
	...
	# Item view class
	class ItemView extends Mildred.View
		tagName: 'li'
		template: '<% if (typeof(title) != "undefined") { %><%=title%><% }%>'
	...
	class TestCollectionView extends Mildred.CollectionView
		tagName: 'ul'
		animationDuration: 0
		itemView: ItemView
	...
	oneModel = ->
		new Mildred.Model id: 'one', title: 'one'
	...
	threeModels = ->
		model1 = new Mildred.Model id: 'new1', title: 'new'
		model2 = new Mildred.Model id: 'new2', title: 'new'
		model3 = new Mildred.Model id: 'new3', title: 'new'
	...
	createCollection = (models) ->
		collection = new Mildred.Collection(models or freshModels())
	...
	describe 'Basic item rendering', ->
		...
		it 'should call a custom initItemView method', ->
			class CustomViewCollectionView extends Mildred.CollectionView
				tagName: 'ul'
				animationDuration: 0
				initItemView: (model) ->
		...
		it 'should init subviews with disabled autoRender', ->
			...
			class AutoRenderCollectionView extends Mildred.CollectionView
	...
	describe 'Complex Reset and Set behavior', ->
		...
		it 'should insert views in the right order on reset', ->
			...
			m0 = new Mildred.Model id: 0
			m1 = new Mildred.Model id: 1
			m2 = new Mildred.Model id: 2
			m3 = new Mildred.Model id: 3
			m4 = new Mildred.Model id: 4
			m5 = new Mildred.Model id: 5
	...
	describe 'Animation', ->
		class AnimatingCollectionView extends Mildred.CollectionView
			tagName: 'ul'
			animationDuration: 1
			itemView: ItemView

		it 'should animate the opacity of new items', ->
			$css = sinon.stub jQuery.prototype, 'css', ->
				this
			$animate = sinon.stub jQuery.prototype, 'animate', ->
				this
		...
		it 'should not animate when re-inserting', ->
			...
			model1 = new Mildred.Model id: 1
			model2 = new Mildred.Model id: 2
			model3 = new Mildred.Model id: 3
