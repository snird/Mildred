...
class Mildred.CollectionView extends Mildred.View
  ...
  optionNames: Mildred.View::optionNames.concat ['renderItems', 'itemView']
  ...
  updateVisibleItems: (item, includedInFilter, triggerEvent = true) ->
    ...
    visibleItemsIndex = Mildred.utils.indexOf @visibleItems, item
